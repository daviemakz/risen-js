...
var buildHttpOptions = function buildHttpOptions(options) {
  return {
    ...
    beforeStart: options.hasOwnProperty('beforeStart') ? options.beforeStart : function (express) {
      return express;
    },
...
var MicroServiceFramework = function (_ServiceCore) {
  ...
  function MicroServiceFramework(options) {
    ...
    _this.eventHandlers = Object.assign.apply(Object, [{}].concat(_toConsumableArray(['onConRequest', 'onConClose'].map(function (func) {
      return typeof options[func] === 'function' ? _defineProperty({}, func, options[func].bind(_assertThisInitialized(_assertThisInitialized(_this)))) : {};
    }))));
  ...
  _createClass(MicroServiceFramework, [{
    ...
    value: function startServer() {
      ...
      return !this.microServiceStarted ? _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    ...
    value: function initGateway() {
      ...
      return new Promise(function (resolve, reject) {
        return (0, _isPortFree.default)(_this4.settings.apiGatewayPort).then(function () {
          ...
          return !_this4.externalInterfaces.apiGateway ? _this4.log('Unable to start gateway, exiting!', 'error', true) || reject(Error('Unable to start gateway, exiting!')) : _this4.log('Service core started!', 'log', true) || resolve(true);
        }).catch(function (e) {
          ...
          try {
            if (httpSettings) {
              ...
              httpSettings.routes.filter(function (route) {
                ...
                _this6.log("This route has an unknown method, skipping: ".concat(JSON.stringify(route, null, 2)), 'warn');

                return false;
              }).forEach(function (route) {
                return expressApp[route.method.toLowerCase()].apply(expressApp, [route.uri].concat(_toConsumableArray(route.middleware || []), [function (req, res, next) {
                  setTimeout(function () {
                    try {
