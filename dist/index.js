...
var buildSecureOptions = function buildSecureOptions(ssl) {
  try {
    return _typeof(ssl) === 'object' ? Object.entries(Object.assign({}, {
      key: void 0,
      cert: void 0,
      ca: void 0
    }, ssl)).map(function (_ref) {
...
var MicroServiceFramework = function (_ServiceCore) {
  ...
  function MicroServiceFramework(options) {
    ...
    _this.conId = 0;
    _this.settings = Object.assign(defaultInstanceOptions, options, Array.isArray(options.http) && options.http.length ? options.http.map(function (httpSettings) {
    ...
    _this.settings.databaseNames.forEach(function (table) {
      _this.db[table] = new _db.default({
        databaseName: table
      }).db;
    });
    ...
    _this.externalInterfaces = {};
    _this.coreOperations = {};
    _this.serviceInfo = {};
    _this.serviceOptions = {};
    _this.serviceData = {};
    _this.inUsePorts = [];
    ['assignCoreFunctions', 'startServerFailed', 'startServer', 'initGateway', 'bindGateway', 'hardenServer', 'startHttpServer'].forEach(function (func) {
  ...
  _createClass(MicroServiceFramework, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 17:
                _this2.log("Micro Service Framework: ".concat(_package.default.version), 'log');
    ...
    value: function assignCoreFunctions() {
      ...
      return new Promise(function (resolve) {
        Object.entries(Object.assign({}, _core.default, _this3.settings.coreOperations)).forEach(function (_ref5) {
    ...
    value: function defineService(name, operations, options) {
      ...
      switch (true) {
        ...
        case typeof operations === 'undefined' || !_fs.default.existsSync(resolvedPath):
          {
            throw new Error("The operations path of the microservice is not defined or cannot be found! PATH: ".concat(resolvedPath));
          }

        case _typeof(require(resolvedPath)) !== 'object' || !Object.keys(require(resolvedPath)).length:
          {
            throw new Error("No operations found. Expecting an exported object with atleast one key! PATH: ".concat(resolvedPath));
          }
    ...
    value: function initGateway() {
      ...
      this.log("Micro Service Framework: ".concat(_package.default.version), 'log');
      return new Promise(function (resolve, reject) {
        (0, _isPortFree.default)(_this4.settings.apiGatewayPort).then(function () {
          ...
          return !_this4.externalInterfaces.apiGateway ? _this4.log('Unable to start gateway, exiting!', 'error') || reject(Error('Unable to start gateway, exiting!')) : _this4.log('Service core started!', 'log') || resolve(true);
        }).catch(function (e) {
          _this4.log("Gateway port not free or unknown error has occurred. INFO: ".concat(JSON.stringify(e, null, 2)), 'log');
    ...
    value: function bindGateway() {
      ...
      return new Promise(function (resolve) {
        _this5.externalInterfaces.apiGateway.on('COM_REQUEST', function (message, data) {
          ...
          data ? _this5.processComRequest(data, message, _this5.conId) : _this5.processComError(data, message, _this5.conId);
          ...
          try {
            if (httpSettings) {
              ...
              httpSettings.routes.filter(function (route) {
                ...
                console.warn("This route has an unknown method, skipping: ".concat(JSON.stringify(route, null, 2)));
                return false;
              ...
              if (_typeof(httpSettings.ssl) === 'object') {
                return _this6.httpsServer.push(_https.default.createServer(httpSettings.ssl, expressApp).listen(httpSettings.port)) && resolve();
              }

              return _this6.httpServer.push(_http.default.createServer(expressApp).listen(httpSettings.port)) && resolve();
            }
    ...
    value: function startServices() {
      ...
      return new Promise(function (resolve, reject) {
        if (Object.keys(servicesInfo)) {
          Promise.all((0, _lodash.shuffle)(Object.keys(servicesInfo).reduce(function (acc, serviceName) {
            ...
            return new Promise(function (resolveLocal, rejectLocal) {
              _this7.initService(name, function (result) {
                result === true ? resolveLocal(true) : rejectLocal(Error("Unable to start microservice! MORE INFO: ".concat(JSON.stringify(result, null, 2))));
              });
            });
          })).then(function () {
            return resolve();
