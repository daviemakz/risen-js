...
var MSCommon = function () {
  ...
  _createClass(MSCommon, [{
    key: "invokeListener",
    value: function invokeListener(port) {
      return _net.default.createListener(port);
    }
  }, {
    key: "invokeSpeaker",
    value: function invokeSpeaker(port) {
      return _net.default.createSpeaker(port);
    }
  }, {
    key: "invokeSpeakerPersistent",
    value: function invokeSpeakerPersistent(port) {
      return _net.default.createSpeakerReconnector(port);
    }
  }, {
    key: "log",
      ...
      return new Promise(function (resolve, reject) {
        try {
          _this2[container].runOnStart.filter(function (func) {
            _this2.log("This not a valid function: ".concat(func), 'warn');
