...
module.exports = {
  storage: function storage(socket, data) {
    ...
    return setTimeout(function () {
      return _this2.databaseOperation(data.body.table, data.body.method, data.body.args, function (status, result, error) {
        if (status) {
  ...
  changeInstances: function () {
    var _changeInstances = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(socket, data) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 11:
              previousPorts = (_ref2 = []).concat.apply(_ref2, _toConsumableArray(this.serviceData[data.body.name].port));
              ...
              _context2.next = 15;
              return startService.call(this, _defineProperty({}, data.body.name, this.serviceInfo[data.body.name]), data.body.instances);
            ...
            case 21:
              ...
              typeof result === 'undefined' ? resObject.resultBody.resData = Object.assign(baseResponse, {
                status: true,
