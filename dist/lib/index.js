...
var ServiceCore = function (_MSCommon) {
  _inherits(ServiceCore, _MSCommon);
  ...
  _createClass(ServiceCore, [{
    ...
    value: function databaseOperation(table, method, args, callback) {
      ...
      return setTimeout(function () {
        try {
          if (_this2.db.hasOwnProperty(table)) {
            var _this2$db$table;

            var result = (_this2$db$table = _this2.db[table])[method].apply(_this2$db$table, _toConsumableArray(args));

            return callback(true, result, null);
          }

          return callback(false, void 0, new Error("The table ".concat(table, " does not exist!")));
        } catch (e) {
    ...
    value: function initService(name, callback) {
      ...
      var handleOnData = function handleOnData(name, type, data) {
        var logOutput = processStdio("".concat(name, "/port:").concat(port), type, data);
    ...
    value: function writeToLogFile(contents) {
      ...
      return this.settings.logPath && (0, _mkdirp.default)((0, _path.dirname)(this.settings.logPath), function (err) {
        err && _this4.log("Unable to write to log file. MORE INFO: ".concat(err), 'warn');
