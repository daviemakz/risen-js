...
var MicroServer = function (_MicroServiceCommon) {
  _inherits(MicroServer, _MicroServiceCommon);
  ...
  function MicroServer() {
    ...
    ['noDataRecieved', 'echoData', 'redirectFailed', 'processRequest', 'assignProcessListers', 'assignOperations', 'processManagement', 'bindService', 'initServer'].forEach(function (func) {
    ...
    return _possibleConstructorReturn(_this, _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
  ...
  _createClass(MicroServer, [{
    ...
    value: function processManagement() {
      return !(0, _isRunning.default)(process.env.parentPid) && setTimeout(function () {
        return process.exit();
      }, 1000);
    }
  }, {
    ...
    value: function initServer() {
      ...
      return new Promise(function (resolve, reject) {
        (0, _isPortFree.default)(parseInt(process.env.port, 10)).then(function () {
          ...
          _this4.log("Service port \"".concat(parseInt(process.env.port, 10), "\" not free or unknown error has occurred. MORE INFO: ").concat(JSON.stringify(e, null, 2)), 'error');

          return reject(Error("Service port \"".concat(parseInt(process.env.port, 10), "\" not free or unknown error has occurred. MORE INFO: ").concat(JSON.stringify(e, null, 2))));
        });
      });
    }
  }, {
    ...
    value: function bindService() {
      ...
      return new Promise(function (resolve) {
        ...
        _this5.interface.on('SERVICE_KILL', function (socket) {
          ...
          _this5.log("[".concat(_this5.conId, "] Micro service connection request processed, kill command recieved!"));
    ...
    value: function processRequest(socket, data) {
      ...
      return this.operations.hasOwnProperty(_funcName) ? this.operations[_funcName](_socket, _commandData) : this.redirectFailed(_socket, _recievedData);
    }
  }, {
    key: "echoData",
