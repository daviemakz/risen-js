...
class MicroServer extends MicroServiceCommon {
  ...
  assignOperations() {
    return new Promise(resolve => {
      // Operation scope
      const operationScope = { sendRequest: this.sendRequest, destroyConnection: this.destroyConnection };
      ...
      this.standardFunctions.forEach(func => (this.operations[func] = this[func].bind(operationScope)));
      // Resolve promise
      return resolve();
    });
  }
